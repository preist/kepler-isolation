...
HELMET_TEXT = "Scratched inside the shell, in a shaking hand:\nMERCER WAS HERE. MERCER IS STILL HERE."
    ...
    rooms["cockpit"] = Room(
        ...
        items=[
            Item(
                "hand terminal",
                "terminal,scanner",
                "A rugged hand scanner. It reads motion — direction and distance. Company-issue.",
                portable=True,
            ),
            Item(
                "company memo",
                "memo,letter,paper",
                "A Halloway-Tanaka directive, printed on real paper. Someone wanted it deniable.",
                portable=True,
                readable_text=MEMO_TEXT,
            ),
        ],
    ...
    rooms["airlock"] = Room(
        ...
        items=[
            Item(
                "EVA suit",
                "suit,eva",
                "A hard-shell EVA suit. Helmet, gloves, seals. It smells faintly of someone else.",
                portable=True,
                wearable=True,
            )
        ],
    ...
    rooms["med_bay"] = Room(
        ...
        items=[
            Item(
                "medkit",
                "medic,kit",
                "A field medical kit. Stims and sealant, and a card that reads USE SPARINGLY.",
                portable=True,
            ),
            Item(
                "recorder log",
                "log,note,recording",
                "A crew recording, cued to its final entry.",
                portable=True,
    ...
    rooms["crew_quarters"] = Room(
        ...
        items=[
            Item(
                "access card",
                "card,id",
                "A Halloway-Tanaka access card. The photo has been scratched out.",
                portable=True,
            )
        ],
    ...
    rooms["galley"] = Room(
        ...
        items=[
            Item(
                "loose can",
                "can",
                "An empty ration can. Light enough to throw. Loud enough to matter.",
                portable=True,
                sound_on_use=3,
            )
        ],
    ...
    rooms["storage"] = Room(
        ...
        items=[
            Item(
                "power coupler",
                "coupler",
                "A power coupling unit. Heavy. Stamped with a hull number that isn't this hull.",
                portable=True,
            ...
            Item(
                "flare",
                "flares",
                "An emergency flare. It burns loud and bright, and tells everything exactly where you are.",
                portable=True,
                sound_on_use=3,
            ),
        ],
    ...
    rooms["engineering_access"] = Room(
        ...
        items=[
            Item(
                "repair kit",
                "kit,tools",
                "A repair kit. Someone already used half of it, in a hurry, badly.",
                portable=True,
            )
        ],
    ...
    rooms["reactor_room"] = Room(
        ...
        items=[
            Item(
                "signal relay",
                "relay",
                "A signal relay. Company-grey. Built to make a small voice carry very far.",
                portable=True,
                required_for_win=True,
            )
        ],
    ...
    rooms["cargo_bay"] = Room(
        ...
        items=[
            Item(
                "antenna key",
                "key",
                "An antenna tuning key, worn to a shine by hands that needed it before you.",
                portable=True,
                required_for_win=True,
            )
        ],
    ...
    rooms["lower_hold"] = Room(
        ...
        items=[
            Item(
                "beacon fragment",
                "fragment",
                "A scorched shard of an older beacon.",
                portable=True,
                readable_text=FRAGMENT_TEXT,
            )
        ],
    ...
    rooms["signal_cave"] = Room(
        ...
        items=[
            Item(
                "distress beacon",
                "beacon,signal",
                "An old beacon, undegraded. That should not be possible. It listens while it calls.",
                portable=False,
                readable_text=BEACON_TEXT,
            )
        ],
    ...
    rooms["black_pool"] = Room(
        ...
        items=[
            Item(
                "old helmet",
                "helmet",
                "A cracked EVA helmet. Not from your crew.",
                portable=True,
                readable_text=HELMET_TEXT,
            )
        ],
