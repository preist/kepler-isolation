...
HIDING_SPOTS = {
    # ── A zone: Command / Antenna ──────────────────────────────────────────
    "a01": [{"name": "viewport instrument alcove", "quality": 20, "reuse": 0}],
    "a02": [{"name": "behind instrument panels", "quality": 25, "reuse": 0}],
    "a03": [{"name": "navigation console shadow", "quality": 20, "reuse": 0}],
    "a04": [{"name": "behind the captain's chair", "quality": 25, "reuse": 0}],
    "a05": [{"name": "behind the desk", "quality": 30, "reuse": 0}],
    "a06": [{"name": "inside the comm array housing", "quality": 35, "reuse": 0}],
    "a07": [{"name": "behind the antenna control racks", "quality": 30, "reuse": 0}],
    "a08": [{"name": "archive alcove", "quality": 35, "reuse": 0}],
    # ── B zone: Operations / Security ─────────────────────────────────────
    "b01": [{"name": "behind a storage cabinet", "quality": 25, "reuse": 0}],
    "b02": [{"name": "inside a wall locker", "quality": 35, "reuse": 0}],
    "b03": [{"name": "behind the server banks", "quality": 30, "reuse": 0}],
    "b04": [{"name": "weapons locker", "quality": 40, "reuse": 0}],
    "b05": [{"name": "detention cell", "quality": 45, "reuse": 0}],
    "b06": [{"name": "under a crew bunk", "quality": 35, "reuse": 0}],
    # ── C zone: Cryo (safe haven but spots still exist for atmosphere) ─────
    "c01": [{"name": "behind the cryo monitoring station", "quality": 25, "reuse": 0}],
    "c02": [{"name": "inside a sealed cryo pod", "quality": 55, "reuse": 0}],
    "c07": [{"name": "behind the emergency equipment rack", "quality": 30, "reuse": 0}],
    "c08": [{"name": "inside the med storage locker", "quality": 35, "reuse": 0}],
    # ── D zone: Science / Medical ─────────────────────────────────────────
    "d01": [{"name": "behind a lab bench", "quality": 25, "reuse": 0}],
    "d02": [{"name": "inside equipment housing", "quality": 35, "reuse": 0}],
    "d03": [{"name": "inside a medical cabinet", "quality": 40, "reuse": 0}],
    "d04": [{"name": "under the surgical table", "quality": 35, "reuse": 0}],
    "d05": [{"name": "behind specimen racks", "quality": 30, "reuse": 0}],
    "d06": [{"name": "behind the morgue drawers", "quality": 40, "reuse": 0}],
    "d07": [{"name": "inside a storage locker", "quality": 35, "reuse": 0}],
    "d08": [{"name": "behind a chemical cabinet", "quality": 30, "reuse": 0}],
    "d09": [{"name": "under a research bench", "quality": 25, "reuse": 0}],
    "d10": [{"name": "inside an isolation chamber", "quality": 50, "reuse": 0}],
    "d11": [{"name": "behind specimen cases", "quality": 40, "reuse": 0}],
    "d12": [{"name": "inside a supply unit", "quality": 35, "reuse": 0}],
    # ── E zone: Crew Quarters / Commons / EVA ─────────────────────────────
    "e01": [{"name": "inside a crew locker", "quality": 35, "reuse": 0}],
    "e02": [{"name": "under a bunk", "quality": 35, "reuse": 0}],
    "e03": [{"name": "behind equipment racks", "quality": 30, "reuse": 0}],
    "e04": [{"name": "behind the lounge couch", "quality": 30, "reuse": 0}],
    "e05": [{"name": "inside a storage closet", "quality": 40, "reuse": 0}],
    "e06": [{"name": "behind supply shelves", "quality": 25, "reuse": 0}],
    "e07": [{"name": "under a work bench", "quality": 25, "reuse": 0}],
    "e08": [{"name": "inside the freezer unit", "quality": 50, "reuse": 0}],
    "e09": [{"name": "chapel alcove", "quality": 40, "reuse": 0}],
    "e10": [{"name": "behind cargo stacks", "quality": 35, "reuse": 0}],
    "e11": [{"name": "under a bunk", "quality": 35, "reuse": 0}],
    "e12": [{"name": "behind EVA suit racks", "quality": 35, "reuse": 0}],
    "e13": [{"name": "behind the lounge couch", "quality": 30, "reuse": 0}],
    # ── F zone: Engineering ───────────────────────────────────────────────
    "f01": [{"name": "behind coolant pipes", "quality": 25, "reuse": 0}],
    "f02": [{"name": "behind fabrication equipment", "quality": 45, "reuse": 0}],
    "f03": [{"name": "inside the tool cage", "quality": 50, "reuse": 0}],
    "f04": [{"name": "behind power conduit bundles", "quality": 30, "reuse": 0}],
    "f05": [{"name": "behind control panels", "quality": 30, "reuse": 0}],
    "f06": [{"name": "inside a maintenance housing", "quality": 40, "reuse": 0}],
    "f07": [{"name": "behind a reactor heat shield", "quality": 45, "reuse": 0}],
    "f08": [{"name": "inside an equipment locker", "quality": 40, "reuse": 0}],
    "f09": [{"name": "behind the generator housing", "quality": 35, "reuse": 0}],
    "f10": [{"name": "behind electrical panels", "quality": 30, "reuse": 0}],
    "f11": [{"name": "inside the service bay", "quality": 40, "reuse": 0}],
    "f12": [{"name": "behind hydraulic equipment", "quality": 35, "reuse": 0}],
    # ── G zone: Cargo / Aft (alien territory) ─────────────────────────────
    "g01": [{"name": "between storage containers", "quality": 35, "reuse": 0}],
    "g02": [{"name": "between cargo stacks", "quality": 50, "reuse": 0}],
    "g03": [{"name": "between cargo stacks", "quality": 50, "reuse": 0}],
    "g04": [{"name": "inside a sealed cargo unit", "quality": 45, "reuse": 0}],
    "g05": [{"name": "behind equipment racks", "quality": 30, "reuse": 0}],
    "g06": [{"name": "under cargo netting", "quality": 25, "reuse": 0}],
    "g07": [{"name": "inside a pressure suit locker", "quality": 45, "reuse": 0}],
    "g08": [{"name": "inside a sealed container", "quality": 40, "reuse": 0}],
    "g09": [{"name": "behind aft machinery", "quality": 30, "reuse": 0}],
    "g10": [{"name": "behind fuel cell racks", "quality": 35, "reuse": 0}],
    # ── M zone: Maintenance tunnels ───────────────────────────────────────
    # Tight, claustrophobic spots. Lower quality — you're easier to find here.
    "m01": [{"name": "pipe recess", "quality": 20, "reuse": 0}],
    "m02": [{"name": "conduit bend shadow", "quality": 20, "reuse": 0}],
    "m03": [{"name": "behind insulation wrap", "quality": 25, "reuse": 0}],
    "m04": [{"name": "junction box housing", "quality": 25, "reuse": 0}],
    "m05": [{"name": "pipe recess", "quality": 20, "reuse": 0}],
    "m06": [{"name": "behind a cable bundle", "quality": 20, "reuse": 0}],
    "m07": [{"name": "conduit access niche", "quality": 25, "reuse": 0}],
    "m08": [{"name": "behind insulation wrap", "quality": 25, "reuse": 0}],
    "m09": [{"name": "junction box housing", "quality": 25, "reuse": 0}],
    "m10": [{"name": "pipe recess", "quality": 20, "reuse": 0}],
    "m11": [{"name": "behind a cable bundle", "quality": 20, "reuse": 0}],
    "m12": [{"name": "conduit bend shadow", "quality": 20, "reuse": 0}],
    "m13": [{"name": "behind a support strut", "quality": 25, "reuse": 0}],
    "m14": [{"name": "pipe recess", "quality": 20, "reuse": 0}],
    "m15": [{"name": "junction box housing", "quality": 25, "reuse": 0}],
    "m16": [{"name": "behind insulation wrap", "quality": 25, "reuse": 0}],
    "m17": [{"name": "conduit access niche", "quality": 25, "reuse": 0}],
    "m18": [{"name": "behind a cable bundle", "quality": 20, "reuse": 0}],
    "m19": [{"name": "pipe recess", "quality": 20, "reuse": 0}],
    "m20": [{"name": "behind a support strut", "quality": 25, "reuse": 0}],
    "m21": [{"name": "conduit bend shadow", "quality": 20, "reuse": 0}],
    "m22": [{"name": "behind insulation wrap", "quality": 25, "reuse": 0}],
    "m23": [{"name": "junction box housing", "quality": 25, "reuse": 0}],
    "m24": [{"name": "pipe recess", "quality": 20, "reuse": 0}],
    "m25": [{"name": "behind a cable bundle", "quality": 20, "reuse": 0}],
    "m26": [{"name": "conduit access niche", "quality": 25, "reuse": 0}],
    "m27": [{"name": "behind a support strut", "quality": 25, "reuse": 0}],
    "m28": [{"name": "pipe recess", "quality": 20, "reuse": 0}],
    "m29": [{"name": "behind insulation wrap", "quality": 25, "reuse": 0}],
    "m30": [{"name": "conduit bend shadow", "quality": 20, "reuse": 0}],
}
